...
/*
 ...
 To redefine all instrumentation functions, set JALANGI_MODE to 'symbolic' and J$.analysis to a 
 suitable library containing redefinitions of W, R, etc.
...
//-------------------------------- Constants ---------------------------------
        ...
        function invokeFun(iid, base, f, args, isConstructor) {
            var g;
            var invoke, val, ic, tmpIsConstructorCall, tmpIsInstrumentedCaller, idx;
...
// We can also inject it statically : don't forget to comment out injection 
// from the code pannel in main.js
// J$.analysis = {};
// ((function (sandbox){
